...
namespace TarotAPI.Migrations
{
    ...
    [Migration("20221208135447_Refactor Naming 4 change Characters to CharactersList for better view")]
    partial class RefactorNaming4changeCharacterstoCharactersListforbetterview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CharacterTeam", b =>
                {
                    b.Property<int>("CharactersListId")
                        .HasColumnType("int");

                    b.Property<int>("TeamsId")
                        .HasColumnType("int");

                    b.HasKey("CharactersListId", "TeamsId");
            ...
            modelBuilder.Entity("CharacterTeam", b =>
                {
                    b.HasOne("TarotAPI.Models.Character", null)
                        .WithMany()
                        .HasForeignKey("CharactersListId")
